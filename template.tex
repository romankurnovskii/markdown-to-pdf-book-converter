...
\newcommand{\headerright}{Trading Indicators}
\newcommand{\downloadlink}{https://romankurnovskii.com/handbooks/trading-indicators-handbook.pdf}
...
\fancyfoot[C]{
    ...
    \quad{\fontsize{8pt}{10pt}\selectfont\color{gray}\textit{version: \today}}
